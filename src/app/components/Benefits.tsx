...
import { Target, TrendingUp, Users, Award, Lock, Microscope } from "lucide-react";
import { ImageWithFallback } from "./figma/ImageWithFallback";
  ...
  const useCases = [
    {
      title: "Cancer Cytogenetics",
      description: "Identify chromosomal changes in leukemia and lymphoma for targeted treatment",
      image: "https://res.cloudinary.com/df0mpizmq/image/upload/v1775819449/imk_uploads/Cytogenetic_mu7grw.webp"
    },
    {
      title: "Constitutional Disorders",
      description: "Diagnose inherited genetic conditions and developmental abnormalities",
      image: "https://res.cloudinary.com/df0mpizmq/image/upload/v1775819889/imk_uploads/Constitutional_zm7pst.jpg"
    },
    {
      title: "Reproductive Genetics",
      description: "Screen for chromosomal abnormalities in reproductive medicine and fertility evaluation",
      image: "https://res.cloudinary.com/df0mpizmq/image/upload/v1775820052/imk_uploads/Reproductive_bbphri.webp"
    },
    {
      title: "Developmental Delays",
      description: "Identify chromosomal causes of developmental delays and intellectual disabilities",
      image: "https://res.cloudinary.com/df0mpizmq/image/upload/v1775820324/imk_uploads/Developmental_sigplr.jpg"
    }
  ];
  ...
  return (
    <section id="benefits" className="py-20 bg-white">
      <div className="container mx-auto px-6">
        ...
        {/* Use Cases Carousel with Ultra-Smooth Transitions */}
        <div className="rounded-3xl p-12 text-white">
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold mb-4 text-gray-900">Clinical Applications</h3>
          ...
          <div className="relative">
              ...
              >
                {useCases.map((useCase, index) => (
                  <div key={index} className="w-full flex-shrink-0 px-4">
                    ...
                    <div 
                      className="relative rounded-2xl overflow-hidden shadow-xl min-h-[400px] transition-all duration-700 ease-[cubic-bezier(0.4,0,0.2,1)]"
                      style={{
                    ...
                    >
                      {/* Gradient Overlay for Better Text Readability and Smoothness */}
                      ...
                      <div className="relative z-10 flex flex-col items-center justify-center text-center p-8 min-h-[400px] animate-in fade-in duration-700">
                        <div className="w-16 h-16 bg-white/20 rounded-xl flex items-center justify-center mb-6 backdrop-blur-sm transform transition-transform duration-500 hover:scale-110">
                          <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                          </svg>
                        </div>
                        <h4 className="text-3xl font-bold mb-4 transform transition-all duration-500">
                          {useCase.title}
                        </h4>
                        <p className="text-white/95 text-lg max-w-md mx-auto leading-relaxed transform transition-all duration-500 delay-100">
                          {useCase.description}
                        </p>
                      </div>
                    </div>
            ...
            {/* Indicators with Smooth Hover Effects */}
                ...
                <button
                  ...
                  className={`transition-all duration-500 ease-out rounded-full ${
                    index === currentIndex 
                      ...
                      : "bg-gray-300 w-2 h-2 hover:bg-gray-400 hover:w-6"
                  }`}
                  aria-label={`Go to slide ${index + 1}`}
                />
              ))}
